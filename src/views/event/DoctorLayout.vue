      ...
      <div class="center">
        <div class="profile">
          <div class="image">
            ...
            <img :src="GStore.doctor.image" width="70" height="70" />
          </div>
          <div class="name">{{ GStore.doctor.name }}</div>
          <div class="name">{{ GStore.doctor.email }}</div>
          <div>
            <svg
...
export default {
  ...
  methods: {
    change() {
      ...
      AuthService.changeRoleToPeople(this.doctorData)
        .then(() => {
